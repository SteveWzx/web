            ...
            $.get('/v1/server?&limit=10&offset='+(10*index)+'',function(data){
                ...
                if(data  && log_length !== 0){
                    for(var i = 0; i < log_length; i++){
                        ...
                        html += '<li class="zc_fpli zc_fpli03"><span class="zc_fpsp">'+data.Result[i].CpuNum+'</span><span class="zc_fpsp">'+data.Result[i].CoreNum+'</span><span class="zc_fpsp">'+data.Result[i].Memory+'</span><span class="zc_fpsp">'+data.Result[i].Disk+'</span><span class="zc_fpsp">'+data.Result[i].Raid+'</span></li>';
                        ...
                        html += '<li class="zc_fpli zc_fpli06"><span class="zc_fpsp">'+data.Result[i].DepartmentId.Name+'</span><span class="zc_fpsp">'+data.Result[i].BusinessId.Name+'</span><span class="zc_fpsp">'+data.Result[i].ServiceTypeId.ServiceName+'</span><span class="zc_fpsp">'+data.Result[i].Admin+'</span><span class="zc_fpsp">'+data.Result[i].User+'</span>';
